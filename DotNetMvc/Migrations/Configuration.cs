...
namespace DotNetMvc.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<DotNetMvc.Contexts.MoviesContext>
    {
        ...
        protected override void Seed(DotNetMvc.Contexts.MoviesContext context)
        {
            ...
            //{
            //    new Review() {Id = 1, Content = "Very good movie.", Rating = 9, Reviewer = "Çağıl Alsaç", MovieId = 1}
            //};
            ...
            //    new MovieDirector() {Id = 4, MovieId = 4, DirectorId = 1}
            //};
            ...
            #region SQL üzerinden ilk verileri oluşturma (Herhangi bir SQL script dosyası üzerinden de (~/SQLs/MoviesMvc8520DB.sql) yapılabilir)
